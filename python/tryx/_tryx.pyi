...
Module sections match the Rust ``lib.rs`` module registration.
"""
...
from .media import AudioSource, AudioSink, VideoSource, VideoSink
from .waproto.whatsapp_pb2 import (
    ...
    VerifiedNameCertificate as _VerifiedNameCertificate,
)
...
class MessageInfo:
    ...
    @property
    def verified_name(self) -> _VerifiedNameCertificate | None: ...
    @property
...
class TryxClient:
    ...
    async def download_media(self, message: _Message) -> bytes: ...
...
class ChatActionsClient:
    ...
    @staticmethod
    def build_message_range(last_message_timestamp: int, last_system_message_timestamp: int | None, messages: list[tuple[_MessageKey, int]]) -> _SyncActionValue.SyncActionMessageRange: ...
    async def archive_chat(self, jid: JID, message_range: _SyncActionValue.SyncActionMessageRange | None = None) -> None: ...
    async def unarchive_chat(self, jid: JID, message_range: _SyncActionValue.SyncActionMessageRange | None = None) -> None: ...
    ...
    async def mark_chat_as_read(self, jid: JID, read: bool, message_range: _SyncActionValue.SyncActionMessageRange | None = None) -> None: ...
    async def delete_chat(self, jid: JID, delete_media: bool, message_range: _SyncActionValue.SyncActionMessageRange | None = None) -> None: ...
    ...
    async def clear_chat(self, jid: JID, delete_starred: bool, delete_media: bool, message_range: _SyncActionValue.SyncActionMessageRange | None = None) -> None: ...
...
class StatusClient:
    ...
    async def send_raw(self, message: _Message, recipients: list[JID], options: StatusSendOptions | None = None) -> str: ...
    async def revoke(self, message_id: str, recipients: list[JID], options: StatusSendOptions | None = None) -> str: ...

class VoipClient:
    async def call(self, peer: JID, audio_source: AudioSource, audio_sink: AudioSink) -> CallHandle: ...
    async def video_call(self, peer: JID, audio_source: AudioSource, audio_sink: AudioSink, video_source: VideoSource, video_sink: VideoSink) -> CallHandle: ...
    async def group_call(self, peers: list[JID], audio_source: AudioSource, audio_sink: AudioSink, video_source: VideoSource | None = None, video_sink: VideoSink | None = None) -> CallHandle: ...
    async def join_call_link(self, token_or_url: str, media: str, audio_source: AudioSource, audio_sink: AudioSink, video_source: VideoSource | None = None, video_sink: VideoSink | None = None) -> CallHandle: ...
...
# ── IQ / Data classes in client module ──
...
class MuteUpdateData:
    ...
    from_full_sync: bool
    @property
    def action(self) -> _SyncActionValue.MuteAction: ...
...
class MarkChatAsReadUpdateData:
    ...
    from_full_sync: bool
    @property
    def action(self) -> _SyncActionValue.MarkChatAsReadAction: ...
...
class ContactUpdateData:
    ...
    from_full_sync: bool
    @property
    def action(self) -> _SyncActionValue.ContactAction: ...
...
class DeleteChatUpdateData:
    ...
    from_full_sync: bool
    @property
    def action(self) -> _SyncActionValue.DeleteChatAction: ...
...
class DeleteMessageForMeUpdateData:
    ...
    from_full_sync: bool
    @property
    def action(self) -> _SyncActionValue.DeleteMessageForMeAction: ...
